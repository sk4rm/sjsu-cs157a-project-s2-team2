...
CREATE TABLE `befriends` (
  ...
  KEY `fk_user_accounts_befriends_2_idx` (`user_id_2`),
  CONSTRAINT `fk_user_accounts_befriends_1` FOREIGN KEY (`user_id_1`) REFERENCES `user_accounts` (`id`),
  CONSTRAINT `fk_user_accounts_befriends_2` FOREIGN KEY (`user_id_2`) REFERENCES `user_accounts` (`id`)

...
DROP TABLE IF EXISTS `virtual_objects`;
...
LOCK TABLES `virtual_objects` WRITE;
/*!40000 ALTER TABLE `virtual_objects` DISABLE KEYS */;
/*!40000 ALTER TABLE `virtual_objects` ENABLE KEYS */;
UNLOCK TABLES;
